                ...
                <form action="#" method="GET" class="card">
                    <div class="table-responsive">
                        <div class="card-body">
                            ...
                            <br>
                            <a href="#"
                                onclick="this.href='/admin/laporan/omzet-pertahun/cetak/'+document.getElementById('tahun').value"
            ...
            $(document).ready(function() {
                ...
                function drawChart() {
                    ...
                    var data = google.visualization.arrayToDataTable([
                        ['Bulan', 'Total Offline', 'Total Online', 'Total Mitra'],

                        @php
                            foreach ($grafik as $d) {
                                echo "['" . $d->bulan . "'," . $d->total_offline . ',' . $d->total_online . ', ' . $d->total_mitra . '],';
                            }
                        @endphp
                    ]);
                    // Set Options
