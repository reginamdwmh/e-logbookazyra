...
<section class="content">
    <div class="card card-danger">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fa fa-table"></i> Data Transaksi Frozen Food
            </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div class="table-responsive">
                <div>
                    <a href="{{route('tambahtransaksifrozenfood')}}" class="btn-btn-primary">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $no = 1;
                        @endphp
                        @foreach($transaksi_frozen_food as $index => $tb) 
                        <tr>
                            ...
                            <a href="/transaksi/data-frozen-food/hapus/{{$tb->id_transaksi_frozen_food}}" onclick="return confirm('Apakah Anda Yakin Menghapus Data?');" title="Hapus" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                            </center></td>
                        </tr>
                        @endforeach
                    </tbody>
