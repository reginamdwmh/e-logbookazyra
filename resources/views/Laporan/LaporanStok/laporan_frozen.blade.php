...
<head>
    ...
    <title>Data Stok Frozen Food</title>
</head>
{{-- <style type="text/css">
        body{
...
<body>
    ...
    <div style="text-align: center;">
        <font size="5"><b>LAPORAN DATA STOK FROZEN FOOD</b></font><br>
    </div>
        ...
        <tbody>
            ...
            @foreach ($stok as $index => $s)
                ...
                <tr>
                    ...
                    <td>{{ $s->nama_makanan }}</td>
                    <td>
                        <center>{{ $s->stok_masuk }}</center>
                    </td>
                    <td>
                        <center>{{ $s->stok_keluar }}</center>
                    </td>
                    <td>
                        <center>{{ $sisa }}</center>
                    </td>
