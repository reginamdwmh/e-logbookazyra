    ...
    <section class="content">
        <div class="card card-danger">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fa fa-table"></i> Laporan Data Transaksi Penjualan Makanan Offline
                </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <form action="#" method="GET" class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="#"
                                    onclick="this.href='/laporan/data-penjualan-makanan/cetak/'+document.getElementById('tglawal').value +
